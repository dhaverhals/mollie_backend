...
var MollieResource = function () {
  /**
   * Constructor
   * @param httpClient
   */
  function MollieResource(httpClient) {
    classCallCheck(this, MollieResource);
  ...
  createClass(MollieResource, [{
    ...
    value: function create(data, cb) {
      ...
      return this.getClient().post(this.getResourceUrl(), data).then(function (response) {
        ...
        return MollieResource.errorHandler(error.response, cb);
      });
    }
...
var Payment = function (_MollieModel) {
  inherits(Payment, _MollieModel);
...
var Payments = function (_MollieResource) {
  inherits(Payments, _MollieResource);
...
var PaymentsResource = function (_MollieResource) {
  inherits(PaymentsResource, _MollieResource);
...
var Refund = function (_MollieModel) {
  inherits(Refund, _MollieModel);
...
var Method = function (_MollieModel) {
  inherits(Method, _MollieModel);
...
var Methods = function (_MollieResource) {
  inherits(Methods, _MollieResource);
...
var Issuer = function (_MollieModel) {
  inherits(Issuer, _MollieModel);
...
var Issuers = function (_MollieResource) {
  inherits(Issuers, _MollieResource);
...
var Refunds = function (_MollieResource) {
  inherits(Refunds, _MollieResource);
...
var Customer = function (_MollieModel) {
  inherits(Customer, _MollieModel);
...
var Customers = function (_MollieResource) {
  inherits(Customers, _MollieResource);
...
var CustomersResource = function (_MollieResource) {
  inherits(CustomersResource, _MollieResource);
...
var Mandate = function (_MollieModel) {
  inherits(Mandate, _MollieModel);
...
var Subscription = function (_MollieModel) {
  inherits(Subscription, _MollieModel);
